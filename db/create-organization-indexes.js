#!/usr/bin/env node
//-----------------------------------------------------------------------------
// db/create-organization-indexes.js
//-----------------------------------------------------------------------------
...
const run = async () => {
  console.log(`[info] Build indexes on the [organizations] collection`)
  const client  = await connectToMongoDB()
  const options = {unique: true}
  await buildSingleFieldIndex(client, `organizations`, {billingId: 1}, options)
}
